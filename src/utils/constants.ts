...
export const DEFAULT_CHAIN_ID =
  process.env.REACT_APP_DEFAULT_CHAIN_ID || (IS_PRODUCTION ? CHAIN_ID.TLOS : CHAIN_ID.TLOS)
...
export const GATEWAY_URL =
  ...
  (IS_PRODUCTION || isProdGateway() ? 'https://gateway.safe.telos.net' : 'https://gateway.safe.telos.net')
